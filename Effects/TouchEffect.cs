...
using HoverState = Shaunebu.Controls.Enums.HoverState;
using HoverStateChangedEventArgs = Shaunebu.Controls.Events.HoverStateChangedEventArgs;
using HoverStatus = Shaunebu.Controls.Enums.HoverStatus;
using HoverStatusChangedEventArgs = Shaunebu.Controls.Events.HoverStatusChangedEventArgs;
using LongPressCompletedEventArgs = Shaunebu.Controls.Events.LongPressCompletedEventArgs;
using TouchInteractionStatus = Shaunebu.Controls.Enums.TouchInteractionStatus;
using TouchInteractionStatusChangedEventArgs = Shaunebu.Controls.Events.TouchInteractionStatusChangedEventArgs;
using TouchState = Shaunebu.Controls.Enums.TouchState;
using TouchStateChangedEventArgs = Shaunebu.Controls.Events.TouchStateChangedEventArgs;
using TouchStatus = Shaunebu.Controls.Enums.TouchStatus;
using TouchStatusChangedEventArgs = Shaunebu.Controls.Events.TouchStatusChangedEventArgs;

namespace Shaunebu.Controls.Effects
{
